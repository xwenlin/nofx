...
## 2025-11-04 - 优化用户提示词结构（避免重复+清晰分离）
...
## 2025-11-04 - 补充4小时序列的EMA20、Volumes和BuySellRatios序列
...
## 2025-11-04 - 修复EMA/MACD/RSI序列计算逻辑问题（数组长度不一致）
...
## 2025-11-04 - 增加AI数据点数量（从10个增加到30个）
...
## 2025-11-04 - 补全提示词所需的所有数据（数据需求完整性修复）
