...
export const translations = {
  en: {
    ...
    rawDecisionJSON: 'Raw Decision JSON',
    ...
    tradesWillAppearHere: 'Trade records will appear here',
    errorLoadingTrades: 'Failed to load trade records',
    errorLoadingDecisions: 'Failed to load decision logs',
    ...
    filterAll: 'All',
    filterDecisionFailed: 'Decision Failed',
    filterActionFailed: 'Action Failed',
    filterHasTrading: 'Has Trading Actions',
    filterWaitOnly: 'Wait Only',
    filterOpenOnly: 'Open Positions',
    filterCloseOnly: 'Close Positions',
    noFilteredDecisions: 'No Decisions Match Filter',
    tryDifferentFilter: 'Try selecting a different filter option',
  ...
  zh: {
    ...
    decisionLogs: '决策日志',
    noTradesYet: '暂无交易记录',
    tradesWillAppearHere: '交易记录将在此显示',
    errorLoadingTrades: '加载交易记录失败',
    errorLoadingDecisions: '加载决策日志失败',
    closeReason: '平仓原因',
    openPrice: '开仓价',
    closePrice: '平仓价',
    time: '时间',
    ...
    previous: '上一页',
    next: '下一页',
    filterByAction: '按动作过滤',
    filterByStatus: '按状态过滤',
    filterAll: '全部',
    filterDecisionFailed: '决策失败',
    filterActionFailed: '动作失败',
    filterHasTrading: '有交易动作',
    filterWaitOnly: '仅等待',
    filterOpenOnly: '仅开仓',
    filterCloseOnly: '仅平仓',
    noFilteredDecisions: '没有匹配的决策',
    tryDifferentFilter: '请尝试选择其他过滤选项',
